...
export default function Index() {
  ...
  async function createTrip() {
    try {
      ...
      // Reset loading state before showing success alert
      ...
      const errorMessage =
        error.response?.status === 500
          ? "Erro interno do servidor. Verifique se o banco de dados está configurado corretamente."
          : "Não foi possível criar a viagem. Verifique sua conexão e tente novamente.";

      Alert.alert("Erro ao criar viagem", errorMessage);
    }
  }
  ...
  async function getTrip() {
    try {
      ...
      if (trip) {
        return router.push({ pathname: "/trip/[id]", params: { id: trip.id } });
      }
    } catch (error) {
